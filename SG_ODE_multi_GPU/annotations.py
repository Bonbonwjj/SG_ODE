...
def get_info(annotations_path,nonperson_filter=True,vocab=None):
    ...
    max_length=2*max_length+1 #19

    return kf_info,video_info,train_list,test_list,max_length

# def get_700_info(kf_info,video_info):
#     kf_info_700={}
#     video_info_700={}
#     count=0
#     for i,k in enumerate(video_info.keys()):
#         video_info_700[k]=video_info[k]
#         count+=len(video_info[k])
#         if i==699:
#             break
#     for i,k in enumerate(kf_info.keys()):
#         kf_info_700[k]=kf_info[k]
#         if i==count-1:
#             break
#
#     return kf_info_700,video_info_700
